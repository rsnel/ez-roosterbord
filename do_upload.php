...
switch ($_FILES['uploadedfile']['error']) {
	...
	case UPLOAD_ERR_FORM_SIZE:
		fatal_error('ge-uploade file te groot volgens policy van roosterphp');
	...
	case UPLOAD_ERR_NO_TMP_DIR:
		fatal_error('kan de file nergens kwijt, Rik moet vragen aan Gert');
	case UPLOAD_ERR_CANT_WRITE:
		fatal_error('schijf vol?, Rik moet vragen aan Gert');
	case UPLOAD_ERR_OK:
		break;
	default:
