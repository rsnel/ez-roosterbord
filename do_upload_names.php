...
$legenda = explode("\t", array_shift($lines));
print_r($legenda);
...
if (($tussenvoegsels_index = array_search('Tussenvoegsels', $legenda)) === FALSE) fatal_error("kolom Voornaam niet gevonden in geupload bestand");

if (($achternaam_index = array_search('Achternaam', $legenda)) === FALSE) fatal_error("kolom Voornaam niet gevonden in geupload bestand");
